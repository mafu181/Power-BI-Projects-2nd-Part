...
* Explore genre popularity and regional availability
...
* Rating and category analysis
* Content description overview
* Director and cast information
* Country availability analysis
* Interactive title-level reporting view
### Key Insights
* Explored detailed title-level content information
* Analyzed release patterns and category distribution
* Evaluated title availability across regions and ratings
...
* Sales value trend analysis
* Count of unique orders
* Average order value comparison
* USA vs Rest of the World performance analysis
### Key Insights
* Identified top-performing product lines based on profitability
...
* Product line performance by customer country
* Total sales overview by year and month
* Sales Value MoM% (Month-over-Month)
* Sales Value YTD (Year-to-Date)
* Interactive KPI reporting visuals
### Key Insights
* Evaluated customer-level profitability trends
